...
const Home = () => (
  <div>
    ...
    <div className="col-md-1"> 
      ...
      <div className="col-md-3" class="animate__animated animate__backInLeft">
        <Picture source="../static/pics/b.jpg" alt="Edward" deployed="https://edward-2.herokuapp.com/" />
      </div>
      <div className="col-md-3" class="animate__animated animate__backInUp">
        <Picture source="../static/pics/a.jpg" alt="Rain or Shine" deployed="https://khny258.github.io/Rain-or-Shine/" />
      </div>
      <div className="col-md-3" class="animate__animated animate__backInRight">
