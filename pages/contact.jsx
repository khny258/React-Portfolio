  ...
  <div>
    ...
    <div className="row">
      <div className="col contactCol">
        ...
        <Card source="../static/pics/resume.png" text={<a href="https://drive.google.com/file/d/1w8XkFlIpB6H0rcPaTyQd3AGF6fGRxO7c/view?usp=sharing" target="_blank" rel="noopener noreferrer"><button type="button" className="btn btn-dark">Resume</button></a>} />
